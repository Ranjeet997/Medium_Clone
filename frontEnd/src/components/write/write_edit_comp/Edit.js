...
import AddFeature from "./models/Add_Feature";
import Notification from "./models/Notification";
import ProfileCard from "../../nav/navmodel/ProfileModel";
import PublishCard from "./models/Publish_card";
...
export default function Edit() {
  ...
  return (
    <div>
        ...
        <div className="flex justify-between  items-center my-1 mx-3 lg:mx-5 xl:mx-[8rem] 2xl:mx-[17rem] xl:my-3">
          <div className="flex items-center space-x-2">
            ...
            <div className="flex text w-[7.5rem] md:w-full md:space-x-4">
              ...
              <button className="text-[.8rem] lg:text-[.95rem] text-stone-400 hover:text-stone-800 mt-5 md:mt-0" onClick={onHandleSave}>
                Saved
              </button>
            </div>
          </div>
      ...
      <div className="main grid mt-[2rem] mb-[5rem] lg:mt-[2.4rem] lg:mb-[5rem] xl:mt-[2.8rem] xl:mb-[7rem]">
